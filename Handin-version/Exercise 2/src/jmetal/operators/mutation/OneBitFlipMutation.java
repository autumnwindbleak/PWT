...
/**
 * This class implements a one bit flip mutation operator.
 * Based on a generated mutation chromosome, flipping of a random
 *  bit involves changing 0 to 1 and 1 to 0.
 */
			...
			if ((solution.getType().getClass() == BinarySolutionType.class) ||
				...
				while(randomnumber < probability){
					...
					for (int i = 0; i < solution.getDecisionVariables().length; i++) {
						// generate a random position and flip the bit
					...
					// flip another bit according to the probability
